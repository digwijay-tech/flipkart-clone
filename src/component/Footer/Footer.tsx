    ...
    <footer className=" bg-[#212121] mt-[25px] border-t-[1] border-[#f5f5f5]">
            ...
            <div>
              <div className=" whitespace-nowrap">
                <div className="mb-4 ">
                  ...
                  <p className="!leading-[18px]">Bengaluru, 560103,</p>
                  <p className="!leading-[18px]">Karnataka, India </p>
                  <p className="!leading-[18px]">CIN : U51109KA2012PTC066107 </p>
                  <p>
                    Telephone :
                    <span><a href="#" className="text-[#2874f0]"> 044-45614700 </a></span>
                    /
                    <span><a href="#" className="text-[#2874f0]">044-67415800</a></span>
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="mt-10 border-t-[1px] border-[#454d5e] py-[25px] w-full flex items-center justify-evenly">
        <div className="flex items-center">
            <img src="https://static-assets-web.flixcart.com/batman-returns/batman-returns/p/images/sell-image-9de8ef.svg"  width="13" height="12"/>
            <a href="#" className="text-[#fff] text-[12px] ms-2 leading-[18px] font-[inter-regular]">
                Become a Seller
            </a>
        </div>
         <div className="flex items-center">
           <img src="https://static-assets-web.flixcart.com/batman-returns/batman-returns/p/images/gift-cards-image-d7ff24.svg"  width="13" height="13"/>
            <a href="#" className="text-[#fff] text-[12px] ms-2 leading-[18px] font-[inter-regular]">
                Advertise
            </a>
        </div>
         <div className="flex items-center">
            <img src="https://static-assets-web.flixcart.com/batman-returns/batman-returns/p/images/help-centre-image-c4ace8.svg"  width="13" height="13"/>
            <a href="#" className="text-[#fff] text-[12px] ms-2 leading-[18px] font-[inter-regular]">
                Gift Cards
            </a>
        </div>
         <div className="flex items-center">
            <img src="https://static-assets-web.flixcart.com/batman-returns/batman-returns/p/images/sell-image-9de8ef.svg" alt="Become a Seller" width="13" height="12"/>
            <a href="#" className="text-[#fff] text-[12px] ms-2 leading-[18px] font-[inter-regular]">
                Help Center
            </a>
        </div>
         <div className="flex items-center">
            <a href="#" className="text-[#fff] text-[12px] ms-2 leading-[18px] font-[inter-regular]">
                © 2007-2025 <span className="font-[inter-regular]">Flipkart.com</span>
            </a>
        </div>
